...
#load functions:
source("/scratch/hswan/thesis_lengthvariant_ID/correct_technical_length_variant_functions.R")
source("/scratch/hswan/thesis_lengthvariant_ID/correct_isomiR_counts_v2_FUNCTION.R")
```
